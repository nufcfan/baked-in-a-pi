...
As `baked-in-a-pi` is quite minimal, take a look at the two provided submodules
...
One of the design philosophies of `baked-in-a-pi` is that tests should exist
