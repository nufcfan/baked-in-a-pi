# [ngBoilerplate](http://joshdmiller.github.com/baked-in-a-pi) [![Build Status](https://api.travis-ci.org/nufcfan/baked-in-a-pi.png?branch=v0.3.2-release)](https://travis-ci.org/nufcfan/baked-in-a-pi)
